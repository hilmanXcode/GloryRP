...
CreateJoinMechPoint()
{
	//JOBS
	new strings[128];
	CreateDynamicPickup(1239, 23, 2233.0579, -2228.4473, 13.5556, -1);
	format(strings, sizeof(strings), "[MECH JOBS]\n{FFFFFF}/joinjob to join");
	CreateDynamic3DTextLabel(strings, COLOR_YELLOW, 2233.0579, -2228.4473, 13.5556, 3.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); // Taxi
}
