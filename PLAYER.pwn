...
CMD:credits(playerid)
{
	...
	strcat(line3, ""LB_E"Server Founder & Author Gamemode: "YELLOW_E"Dandy_Prasetyo\n");
	strcat(line3, ""LB_E"Author Gamemode: "YELLOW_E"Adam, Faizal R(apksamp.com)\n");
	strcat(line3, ""LB_E"Server Manager From SOIRP: "YELLOW_E"Pasha\n");
	strcat(line3, ""LB_E"Support Mapper From SOIRP: "YELLOW_E"M Hamzah, Dandy_Prasetyo\n");
	strcat(line3, ""LB_E"Support Website From SOIRP: "YELLOW_E"Dandy_Prasetyo\n");
	strcat(line3, ""LB_E"Last Update By : "YELLOW_E"PWRP\n");
	strcat(line3, ""LB_E"Reupdate Gamemode: "YELLOW_E"MrDNM A.K.A Hilman\n");
...
/*CMD:setnametw(playerid, params[])
{
    new otherid, tmp[20];
	if(sscanf(params, "is[20]", otherid, tmp))
	{
	   	Usage(playerid, "/setnametw <ID/Name> <NewNameTw>");
	    return 1;
	}
	...
	format(pData[playerid][pNameTwt], 20, tmp);
	SendClientMessageEx(playerid, COLOR_RED, "[SetNameTwt]"YELLOW_E" Kamu Telah Mensetnama id %d menjadi %s", otherid, pData[playerid][pNameTwt]);
	// Disini Save Datanya Ke Database , Sesuai Database yang lu pake :v
	return 1;
}*/
...
CMD:vip(playerid)
{
	...
	"YELLOW_E"Untuk informasi selengkapnya hubungi Benjaminn(Server Owner & Founder)!");
	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"GRP "PINK_E"VIP SYSTEM", longstr2, "Close", "");
	return 1;
}
...
{
    new line3[3500];
    strcat(line3, ""RED_E"...:::... "DOOM_"Donate List Prime World "RED_E"...:::...\n");
    strcat(line3, ""RED_E"..:.. "DOOM_"GOLD(OOC) "RED_E"..:..\n\n");

    strcat(line3, ""DOOM_"1. 250 Gold >> "RED_E"Rp 15.000\n");
    strcat(line3, ""DOOM_"2. 525 Gold >> "YELLOW_E"Rp 25.000\n");
	strcat(line3, ""DOOM_"3. 1125 Gold >> "GREEN_E"Rp 50.000\n");
    strcat(line3, ""DOOM_"4. 2150 Gold >> "RED_E"Rp 100.000\n");
	strcat(line3, ""DOOM_"5. 3125 Gold >> "YELLOW_E"Rp 150.000\n");
    strcat(line3, ""DOOM_"6. 4200 Gold >> "GREEN_E"Rp 200.000\n\n");

	strcat(line3, ""RED_E"..::.. "DOOM_"VIP PLAYER "RED_E"..::..\n\n");
	
    strcat(line3, ""DOOM_"1. VIP Regular(1 Month) >> "RED_E"500 Gold\n");
    strcat(line3, ""DOOM_"2. VIP Premium(1 Month) >> "YELLOW_E"900 Gold\n");
    strcat(line3, ""DOOM_"3. VIP Platinum(1 Month) >> "GREEN_E"1200 Gold\n\n");

	strcat(line3, ""RED_E"..:::.. "DOOM_"SERVER FEATURE "RED_E"..:::..\n\n");
    strcat(line3, ""DOOM_"1. Mapping(per object) >> "RED_E"60 Gold\n");
	strcat(line3, ""DOOM_"2. Private Door >> "GREEN_E"100 Gold\n");
	strcat(line3, ""DOOM_"3. Private Gate >> "YELLOW_E"200 Gold\n");
	strcat(line3, ""DOOM_"4. Bisnis >> "GREEN_E"(Tergantung Lokasi)\n");
	strcat(line3, ""DOOM_"5. House >> "RED_E"(Tergantung Lokasi dan Type)\n");
	strcat(line3, ""DOOM_"6. Custom House Interior >> "YELLOW_E"(Tergantung Interior)\n\n");
	
	strcat(line3, ""RED_E"..::::.. "DOOM_"SERVER VEHICLE "RED_E"..:::::..\n\n");
    strcat(line3, ""DOOM_"1. VEHICLE IN DEALER >> "RED_E"1200 Gold\n");
	strcat(line3, ""DOOM_"2. VEHICLE NON DEALER >> "YELLOW_E"1800 Gold\n");
	strcat(line3, ""DOOM_"3. BOAT / HELI >> "GREEN_E"2300 Gold\n\n");

    strcat(line3, ""RED_E"..::.. "WHITE_E"CONTACT INFO "RED_E"..::..\n");
    strcat(line3, ""WHITE_E"1. NAMA : "RED_E"Benjaminn\n");
    strcat(line3, ""WHITE_E"-  GMAIL: "RED_E"benjamintato53@gmail.com\n\n");
	
    strcat(line3, ""WHITE_E"2. NAMA : "RED_E"Benjaminn\n");
    strcat(line3, ""WHITE_E"-  WA : "RED_E"083818972845\n\n");
	...
	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"GRP: "WHITE_E"DONATE LIST", line3, "Okay", "");
	return 1;
}
...
CMD:death(playerid, params[])
{
    ...
    if((gettime()-GetPVarInt(playerid, "GiveUptime")) < 300)
        return Error(playerid, "You must waiting 5 minutes for spawn to hospital");
...
CMD:time(playerid)
{
	...
	format(line2, sizeof(line2), ""WHITE_E"Paycheck Time: "YELLOW_E"%d remaining\n"WHITE_E"Job Delay Time: "RED_E"%d second\n"WHITE_E"Side Job Delay Time: "RED_E"%d second\n"WHITE_E"Plant Time(Farmer): "RED_E"%d second\n"WHITE_E"Arrest Time: "RED_E"%d second\n"WHITE_E"Jail Time: "RED_E"%d second\n", paycheck, pData[playerid][pJobTime], pData[playerid][pSideJobTime], pData[playerid][pPlantTime], pData[playerid][pArrestTime], pData[playerid][pJailTime]);
   	ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""ORANGE_E"GRP: "WHITE_E"My Time", line2, "Okay", "");
	return 1;
}
	...
	foreach(new i : PVehicles)
	{
		if(vehid == pvData[i][cVeh])
		{
			if(pvData[i][cOwner] == pData[playerid][pID])
			{
				...
				format(pvData[i][cPlate], 32, "GRP-%d", rand);
	...
	if(pData[playerid][pVip] > 0)
	{
		if(pData[playerid][pJob] == 0 || pData[playerid][pJob2] == 0)
		{
			if(pData[playerid][pJob] == 0)
			{
				...
				else if(pData[playerid][pJob] == 0 && GetPlayerState(playerid) == 1 && IsPlayerInRangeOfPoint(playerid, 3.0, 2233.0579, -2228.4473, 13.5556))
				{
			...
			else if(pData[playerid][pJob2] == 0)
			{
				...
				else if(pData[playerid][pJob2] == 0 && GetPlayerState(playerid) == 1 && IsPlayerInRangeOfPoint(playerid, 3.0, 2233.0579, -2228.4473, 13.5556))
				{
...
CMD:give(playerid, params[])
{
	if(IsPlayerConnected(playerid)) 
	{
		...
		{
		    if(ammount < 0) return Error(playerid, "Wah, Kamu Kang Abuse Yaa.");
...
{
	if(pData[playerid][pPhone] == 0) return Error(playerid, "Kamu Tidak Mempunyai Telepon !");
	if(pData[playerid][pLoggedAccountTwt] == 0)
	{
		ShowPlayerDialog(playerid, DIALOG_MENU_TWEET, DIALOG_STYLE_LIST, "Media Sosial Tweetter", "Login\nRegister\nLupa Password(Beta Version)", "Select", "Cancel");
	}
	else if(pData[playerid][pLoggedAccountTwt] == 1)
	{
	    ShowPlayerDialog(playerid, DIALOG_LOGGED_MENU, DIALOG_STYLE_LIST, "Media Sosial Tweetter", "Membuat Postingan\nMengubah/Mengisi Bio\nMengubah Password", "Select", "Cancel");
	}
	return 1;
}
...
CMD:buy(playerid, params[])
{
	...
	//Component
	if(IsPlayerInRangeOfPoint(playerid, 2.5, 854.6003, -605.2056, 18.4219))
	{
	    new String[500];
        format(String, sizeof(String), "Component Price: $5\nComponent Available: %d", StockComp);
		ShowPlayerDialog(playerid, DIALOG_COMPONENT, DIALOG_STYLE_INPUT, "TOKO COMPONENT", String, "Beli", "Cancel");
	}
	//Apotek
	...
	// Buy Vending Machine, Food Or Drink
	for(new idx = 1; idx < sizeof(VendingInfo); idx++)
	{
		if(IsPlayerInRangeOfPoint(playerid, 3, VendingInfo[idx][PosX], VendingInfo[idx][PosY], VendingInfo[idx][PosZ]))
		{
			if(VendingInfo[idx][VenOwned] == 0)
			{
				if(VendingInfo[idx][VenType] == 0)
				{
					new String[1000];
					if(pData[playerid][pOwnedVending] > 0) return Info(playerid, "Kamu Sudah Memiliki Vending Machine.");
					if(pData[playerid][pMoney] < VendingInfo[idx][VenPrice]) return Info(playerid, "Uang Kamu Tidak Cukup.");
					format(VendingInfo[idx][VenOwner], 50, "%s", pData[playerid][pName]);
					if(IsValidDynamic3DTextLabel(VenLabel[idx]))
						DestroyDynamic3DTextLabel(VenLabel[idx]);
					format(String, sizeof(String), ""RED_E"[ID : %d]\n"YELLOW_E"Owner Vending ["RED_E"%s"YELLOW_E"]\n Harga Minuman ["GREEN_E"$%d"YELLOW_E"]\n /buy Untuk Membeli Minuman", idx, VendingInfo[idx][VenOwner], VendingInfo[idx][VenProdPrice]);
					VenLabel[idx] = CreateDynamic3DTextLabel(String, COLOR_YELLOW, VendingInfo[idx][PosX], VendingInfo[idx][PosY], VendingInfo[idx][PosZ], 10);
					VendingInfo[idx][VenOwned] = 1;
					pData[playerid][pOwnedVending] = 1;
					GivePlayerMoneyEx(playerid, pData[playerid][pMoney]-VendingInfo[idx][VenPrice]);
					Info(playerid, "Kamu Telah Membeli Vending Machine Ini.");
					SaveVending();
				}
				else if(VendingInfo[idx][VenType] == 1)
				{
					new String[1000];
					if(pData[playerid][pOwnedVending] > 0) return Info(playerid, "Kamu Sudah Memiliki Vending Machine.");
					if(pData[playerid][pMoney] < VendingInfo[idx][VenPrice]) return Info(playerid, "Uang Kamu Tidak Cukup.");
					...
					if(IsValidDynamic3DTextLabel(VenLabel[idx]))
						DestroyDynamic3DTextLabel(VenLabel[idx]);
					format(String, sizeof(String), ""RED_E"[ID : %d]\n"YELLOW_E"Owner Vending ["RED_E"%s"YELLOW_E"]\n Harga Snack ["GREEN_E"$%d"YELLOW_E"]\n /buy Untuk Membeli Snack", idx, VendingInfo[idx][VenOwner], VendingInfo[idx][VenProdPrice]);
					VenLabel[idx] = CreateDynamic3DTextLabel(String, COLOR_YELLOW, VendingInfo[idx][PosX], VendingInfo[idx][PosY], VendingInfo[idx][PosZ], 10);
					VendingInfo[idx][VenOwned] = 1;
					pData[playerid][pOwnedVending] = 1;
					GivePlayerMoneyEx(playerid, pData[playerid][pMoney]-VendingInfo[idx][VenPrice]);
			...
			else
			{
				if(VendingInfo[idx][VenType] == 0)
				{
					VendingInfo[idx][VenMoney] += VendingInfo[idx][VenProdPrice];
					VendingInfo[idx][VenStock]--;
					pData[playerid][pMoney] -= VendingInfo[idx][VenProdPrice];
					ApplyAnimation(playerid, "VENDING", "VEND_USE", 4.1, 0, 1, 1, 1, 1, 1);
					SetTimerEx("VendingDrink", 2300, 0, "i", playerid);
					Info(playerid, "Kamu Telah Membeli Soda Dengan Harga "GREEN_E"$%d", VendingInfo[idx][VenProdPrice]);
					SaveVending();
				}
				else if(VendingInfo[idx][VenType] == 1)
				{
					...
					pData[playerid][pMoney] -= VendingInfo[idx][VenProdPrice];
					ApplyAnimation(playerid, "VENDING", "VEND_USE", 4.1, 0, 1, 1, 1, 1, 1);
					SetTimerEx("VendingEat", 3000, 0, "i", playerid);
					Info(playerid, "Kamu Telah Membeli Snack Dengan Harga "GREEN_E"%d", VendingInfo[idx][VenProdPrice]);
					SaveVending();
				}
			}
		}
